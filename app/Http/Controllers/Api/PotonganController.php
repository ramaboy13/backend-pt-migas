...
class PotonganController extends Controller
{
  ...
  public function getByPeriode(Request $request): JsonResponse
  {
    try {
      ...
      $result = $this->service->getPotonganByPeriode($periode);
      ...
      return response()->json([
        'success' => false,
        'message' => 'Gagal mengambil data potongan berdasarkan periode',
        'data' => null
      ], 500);
    }
  }

  public function getTotalByPeriode(Request $request): JsonResponse
  {
    try {
      $periode = $request->input('periode', date('Y-m-d'));
      $total = $this->service->getTotalPotonganByPeriode($periode);
      ...
      return response()->json([
        'success' => false,
        'message' => 'Gagal mengambil total potongan',
        'data' => null
      ], 500);
    }
  }
